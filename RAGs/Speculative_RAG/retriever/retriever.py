"""
Retriever: load documents from data/, chunk, embed with OpenAI, store in FAISS or numpy, return top-k.
"""
...
class Retriever:
    ...
    Uses FAISS when available; falls back to numpy L2 search.
    Persists index and chunks to disk. Works with OpenAI or Azure OpenAI client.
    """
